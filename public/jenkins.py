...
def jenkins_main(project_url, job_name, reason, build_number, total, array):
    replace_list = []
    ...
    replace_list.extend([project_url, status, job_name, git_url, build_number, total, reason, allure_url, failed_list, console])
